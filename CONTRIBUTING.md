...
dependencies, polymorphic collaborators use abstract base classes, package code performs no file or
process I/O, and feature packages are not export barrels.
